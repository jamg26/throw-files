            ...
            <CardBody>
              <div style={{ display: "flex", flexDirection: "column", gap: "24px", width: "100%" }}>
                ...
                <HeaderSection>
                  ...
                  <h1 style={{ margin: 0, color: "var(--text-primary)", letterSpacing: "-1px", fontFamily: "'Inter', sans-serif" }}>
                    Privacy Policy
                  </h1>
                ...
                <Section>
                  <h3 style={{ color: "var(--accent-primary)", fontFamily: "'Inter', sans-serif" }}>Our Philosophy</h3>
                  <p>
                ...
                <Section>
                  <h4 style={{ color: "var(--text-primary)", fontFamily: "'Inter', sans-serif" }}>1. Data Transmission (P2P)</h4>
                  <p>
                ...
                <Section>
                  <h4 style={{ color: "var(--text-primary)", fontFamily: "'Inter', sans-serif" }}>2. Zero Data Storage</h4>
                  <p>
                ...
                <Section>
                  <h4 style={{ color: "var(--text-primary)", fontFamily: "'Inter', sans-serif" }}>3. Tracking & Cookies</h4>
                  <p>
                ...
                <Section>
                  <h4 style={{ color: "var(--text-primary)", fontFamily: "'Inter', sans-serif" }}>4. Security</h4>
                  <p>
                ...
                <Section>
                  <h4 style={{ color: "var(--text-primary)", fontFamily: "'Inter', sans-serif" }}>5. Contact</h4>
                  <p>
                    As an open-source project, we are committed to transparency. If you have questions about the underlying technology or our privacy practices, you can reach out via our GitHub repository or at <a href="mailto:jammmg26@gmail.com" style={{ color: "var(--accent-primary)" }}>jammmg26@gmail.com</a>.
                  </p>
                </Section>
